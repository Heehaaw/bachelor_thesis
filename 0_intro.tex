...
Aby tento cíl mohl být dosažen, je kritické mít dobrý \nom{ASR}{Automatic Speech Recognition - automatické rozpoznávání řeči} (Automatic Speech Recognition) systém. Těchto se pohybuje v éteru mnoho, volně dosažitelných, rozličné kvality a spolehlivosti. Pro specifické využití v této práci byl zvolen systém 
