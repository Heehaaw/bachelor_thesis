...
\noindent
Děkuji panu doktorovi Jurčíčkovi za profesionální vedení této práce a jeho neutuchající víru v mou schopnost samostatného vývoje.
...
common user interacts with their web browser almost exclusively using mouse and keyboard. Thanks to the software this thesis represents the user has an opportunity of 
delving into sometimes unpopular language learning process using his natural voice. This fact presents new and exciting possibilities, mainly regarding user 
interactivity. Big stress has been put to user friendliness, graphical fidelity and to competitive aspect of language education, exploiting Facebook integration and 
point-scoring leader boards.
...
\textbf{ASR} -- Automatic Speech Recognition -- automatické rozpoznávání řeči
